  ...
  export default {
    ...
    props: {
      data: {
        ...
        default () {
          return {
            'mainTitle1': {id: 'mainTitle1', type: 'title', children: ['subTitle1-1', 'subTitle1-2'], text: '主标题名称1', isRoot: true},
            ...
            'mainTitle2': {id: 'mainTitle2', type: 'title', children: ['subTitle2-1', 'subTitle2-2'], text: '主标题名称2', isRoot: true},
            ...
            'mainTitle3': {id: 'mainTitle3', type: 'title', children: ['content3-0-1'], text: '主标题名称3', isRoot: true},
